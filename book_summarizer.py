...
class ArticleSummarizer:
    ...
    def batch_process_articles(self, input_dir, output_dir="summary_results"):
        ...
        files.sort(key=lambda x: int(x.split('_')[1].split('.')[0]))  # 按segment_XXX.txt中的XXX数字排序
...
if __name__ == "__main__":
    summarizer = ArticleSummarizer(
        ...
        summary_model="gemini-2.0-flash",      # 用于生成总结的模型  # 备选gemini-2.0-pro-exp-02-05
        extraction_model="gemini-2.0-flash",   # 用于提取核心观点的模型  # 备选gpt-4o-mini
        temperature=0.3,
        base_url="https://zzzzapi.com/v1"  # optional
    )

    # 支持单文件处理
    # article_path = "/home/mao/workspace/medium_scrape/Tools/book_segment/segment_011.txt"
    ...
    # 支持批量处理
    input_directory = "/home/mao/workspace/medium_scrape/Tools/book_segment"  # 包含多个txt文件的目录
